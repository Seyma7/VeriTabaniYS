  ...
  public function EncodeQ ($str, $position = 'text') {
    ...
    switch (strtolower($position)) {
      case 'phrase':
        ...
        $encoded = preg_replace_callback(   // php5.x preg_replace_callback() method
										'/([^A-Za-z0-9!*+\/ -])/',
										function($m){
...
$mail->Port       = 25;
$mail->Host       = "89.19.3.9";
$mail->Username   = "bulten@stokcd.com";
$mail->Password   = "x135790x";
$mail->SetFrom("sistem@stokcd.com",'Stokcd.com');
$mail->Subject    = 'Stokcd.com';
$mail->MsgHTML('test');
$mail->AddAddress('yahya@inixhost.com', 'yahya');
$mail->Send();
*/
